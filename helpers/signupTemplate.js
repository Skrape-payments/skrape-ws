const signupTemplate = (data, otp) => {
                      ...
                      <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                          <tbody><tr>
                              <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                          ...
                                          <img align="center" alt="" src="https://mcusercontent.com/4366224bc18ee1d9f39c1f4a8/images/491302d7-5a2f-4474-664a-a3cc1f119148.png" width="152.28" style="max-width:1357px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
  ...
  <p>Thank you for signing up with&nbsp;Skrape.</p>
                              ...
                              <table border="0" cellspacing="0" class="mcnTextContentContainer" width="100%" style="min-width: 100% !important;background-color: #404040;">
                                  <tbody><tr>
                                      <td valign="top" class="mcnTextContent" style="padding: 18px;color: #F2F2F2;font-family: Helvetica;font-size: 14px;font-weight: normal;text-align: center;">
                                          Please use the <span style="color:#99cc00">OTP</span> code <span style="color:#99cc00"><strong>[${otp}]</strong> </span>to complete you're registration.<br>
  Thank you.
                                      </td>
                                  </tr>
                              </tbody></table>
  ...
  -->
                  ...
                  <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                      <tbody><tr>
                          ...
                          <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                              ...
                              <em>Copyright © 2022 Skrape Payments, All rights reserved.</em>
                          </td>
                      </tr>
                  </tbody></table>
                  <!--[if mso]>
      ...
      <script type="text/javascript"  src="/KNbZxz/k_FGd/Z2LLa/Sg/zY9SS8Q4/YnB5eA/X2BbT/1EvXgkB"></script></body>
  </html>
